  ...
  <form action="register.php" method="post"> 
    <section class="loginForm"> 
      ...
      <div class="loginForm_content"> 
        <fieldset> 
          <div class="inputWrap"> 
            <input type="text" name="userName" maxlength="20" placeholder="userName" autofocus required> 
          </div> 
          <div class="inputWrap"> 
...
<?php
    if (isset($_POST['register']))
    {
        ...
        $score4=0;
        $score5=0;
        $sql="select * from player where id = '$name';";
        //$sql = 'select * from player where id = "XieChenwei";';
        ...
        if (!empty($result['id']))
        {
            echo "<script>alert('ID has existed');</script>";
        }

        else
        {
            $sql="insert into player value ('$name', '$pass', '$score1', '$score2', '$score3', '$score4', '$score5'); ";
            //$sql = 'select * from player where id = "XieChenwei";';
            //echo "<script>alert('$sql');</script>";
            ...
            {
                echo '<script>
                    alert("Register Succeed, Have Fun!");
                    window.close();
             </script>';
            }
        }
